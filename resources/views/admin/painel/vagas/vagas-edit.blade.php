        ...
        <div class="col-lg-9 order-lg-1">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Editar vaga</h6>
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route('admin.vagas.update', ['vaga' => $vaga->id]) }}" autocomplete="off">
                        @csrf
                        @method('PUT')
                        <div class="pl-lg-4">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" class="form-control form-control-user{{ $errors->has('titulo') ? ' is-invalid' : '' }}" id="titulo" required name="titulo" placeholder="Exemplo titulo" value="{{ $vaga->titulo }}">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group focused">
                                        ...
                                        <select class="form-control form-control-user{{ $errors->has('regime_contratual') ? ' is-invalid' : '' }}" name="regime_contratual" id="regime_contratual" required>
                                            ...
                                            <option value="CLT" {{ $vaga->regime_contratual == "CLT"?"selected":"" }}>CLT</option>
                                            <option value="PJ"  {{ $vaga->regime_contratual == "PJ"?"selected":"" }}>PJ</option>
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group focused">
                                        ...
                                        <input type="number" class="form-control form-control-user{{ $errors->has('quantidade') ? ' is-invalid' : '' }}" id="quantidade" required name="quantidade" placeholder="3" value="{{ $vaga->quantidade }}">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" class="form-control form-control-user{{ $errors->has('remuneracao') ? ' is-invalid' : '' }}" id="titulo" required name="remuneracao" placeholder="R$ 2000,00" value="{{ $vaga->remuneracao }}">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group focused">
                                        ...
                                        <br>
                                        <textarea name="descricao" id="descricao" class="form-control form-control-user{{ $errors->has('descricao') ? ' is-invalid' : '' }}" rows="3" placeholder="Descrição vaga" required>{{ $vaga->descricao }}</textarea>
                                    ...
                                    <div class="form-group focused">
                                        ...
                                        <select class="form-control form-control-user{{ $errors->has('area_id') ? ' is-invalid' : '' }}" name="area_id" id="area_id" required>
                                            ...
                                            @foreach ($areas as $area)
                                                <option value="{{ $area->id }}" {{ $vaga->area_id == $area->id? "selected":"" }}>{{ $area->nome }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group focused">
                                        ...
                                        <select class="form-control form-control-user{{ $errors->has('empresa_id') ? ' is-invalid' : '' }}" name="empresa_id" id="empresa_id" required>
                                            ...
                                            @foreach ($empresas as $empresa)
                                                <option value="{{ $empresa->id }}" {{ $vaga->empresa_id == $empresa->id? "selected":"" }}>{{ $empresa->razao_social }}</option>
                                            @endforeach
                                        </select>
