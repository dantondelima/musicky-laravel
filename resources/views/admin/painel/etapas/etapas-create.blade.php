...
@section('title', 'Criar etapa')

@section('main-content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Etapas</h1>
        ...
        <div class="col-lg-9 order-lg-1">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Criar etapa</h6>
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route('admin.vagas.etapa-processo.store', ['vaga' => $vaga]) }}" autocomplete="off">
                        @csrf
