        ...
        <div class="col-lg-9 order-lg-1">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Editar candidato</h6>
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route('admin.candidatos.update', ['candidato' => $candidato->id]) }}" autocomplete="off">
                        @csrf
                        @method('PUT')
                        <div class="pl-lg-4">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" class="form-control form-control-user{{ $errors->has('nome') ? ' is-invalid' : '' }}" id="nome" required name="nome" placeholder="Exemplo nome" value="{{ $candidato->nome }}">
                                        @if ($errors->has('nome'))
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" class="form-control form-control-user{{ $errors->has('cpf') ? ' is-invalid' : '' }}" id="cpf" required name="cpf" placeholder="000.000.000-00" value="{{ $candidato->cpf }}">
                                        @if ($errors->has('cpf'))
                                            <small class="text-danger" role="alert">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group focused">
                                        ...
                                        <input type="email" class="form-control form-control-user{{ $errors->has('email') ? ' is-invalid' : '' }}" id="email" required name="email" placeholder="exemplo@1job.com.br" value="{{ $candidato->email }}">
                                        @if ($errors->has('email'))
                                            <small class="text-danger" role="alert">
