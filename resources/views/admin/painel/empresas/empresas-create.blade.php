        ...
        <div class="col-lg-9 order-lg-1">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Criar empresa</h6>
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route('admin.empresas.store') }}" autocomplete="off">
                        @csrf
                        <div class="pl-lg-4">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" class="form-control form-control-user{{ $errors->has('razao_social') ? ' is-invalid' : '' }}" id="razao_social" required name="razao_social" placeholder="Exemplo razão social" value="{{old('razao_social')}}">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" class="form-control form-control-user{{ $errors->has('nome_fantasia') ? ' is-invalid' : '' }}" id="nome_fantasia" required name="nome_fantasia" placeholder="Exemplo nome fantasia" value="{{old('nome_fantasia')}}">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" class="form-control form-control-user{{ $errors->has('cnpj') ? ' is-invalid' : '' }}" id="cnpj" required name="cnpj" placeholder="00.000.000/0000-00" value="{{old('cnpj')}}">
                                        @if ($errors->has('cnpj'))
                                            <small class="text-danger" role="alert">
